    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="logo-area">
                    <a href="#"><img class="logo" src="{{ asset('img/logo/logo-blanco-150x130.png') }}" alt="" /></a>
                </div>
            </div>
                            ...
                            <div role="menu" class="dropdown-menu message-dd animated zoomIn">
                                ...
                                <div class="hd-message-info">
                                    <a href="#">
                                        <div class="hd-message-sn">
                                            <div class="hd-message-img">
                                                <img src="{{ asset('img/post/1.jpg') }}" alt="" />
                                            </div>
                                            <div class="hd-mg-ctn">
                                                <h3>David Belle</h3>
                                    ...
                                    <a href="#">
                                        <div class="hd-message-sn">
                                            <div class="hd-message-img">
                                                <img src="{{ asset('img/post/4.jpg') }}" alt="" />
                                            </div>
                                            <div class="hd-mg-ctn">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                    ...
                    <li><a data-toggle="tab" href="#mailbox"><i class="notika-icon notika-edit"></i> Membresia</a>
                    </li>
